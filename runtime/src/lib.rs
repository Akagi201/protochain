//! The Substrate Node Protochain runtime. This can be compiled with `#[no_std]`, ready for Wasm.
...
pub const VERSION: RuntimeVersion = RuntimeVersion {
    spec_name: create_runtime_str!("protochain"),
    impl_name: create_runtime_str!("protochain"),
    authoring_version: 1,
    spec_version: 1,
    impl_version: 0,
