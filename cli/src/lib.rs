...
extern crate protochain_executor;
...
use std::sync::Arc;
use protochain_primitives::{AccountId, Hash};
use protochain_runtime::{Block, BlockId, GenesisConfig,
	ConsensusConfig, CouncilConfig, DemocracyConfig, SessionConfig, StakingConfig,
	TimestampConfig};
use futures::{Future, Sink, Stream};
use tokio::runtime::Runtime;
use protochain_executor::NativeExecutor;
	...
	T: Into<std::ffi::OsString> + Clone,
{
	...
	let client = Arc::new(client::new_in_mem::<NativeExecutor<protochain_executor::Executor>, Block, _>(executor, genesis_config)?);
