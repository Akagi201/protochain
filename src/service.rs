...
use protochain_runtime::{self, opaque::Block, GenesisConfig, RuntimeApi};
...
native_executor_instance!(
	pub Executor,
	protochain_runtime::api::dispatch,
	protochain_runtime::native_version,
	include_bytes!("../runtime/wasm/target/wasm32-unknown-unknown/release/protochain_runtime.compact.wasm")
);
