...
use protochain_runtime::{
	AccountId, BalancesConfig, ConsensusConfig, GenesisConfig, TimestampConfig, UpgradeKeyConfig,
};
...
fn testnet_genesis(
	...
	GenesisConfig {
		consensus: Some(ConsensusConfig {
			code: include_bytes!(
				"../runtime/wasm/target/wasm32-unknown-unknown/release/protochain_runtime.compact.wasm"
			)
			.to_vec(),
		...
		upgrade_key: Some(UpgradeKeyConfig { key: upgrade_key }),
	}
}
